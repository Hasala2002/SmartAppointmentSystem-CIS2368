...
class Appointment(Base):
    ...
    last_dental_visit = Column(Enum("within-6-months", "6-12-months", "over-a-year", "never", name="last_dental_visit_enum"), nullable=True)
    has_dental_pain = Column(Boolean, nullable=True)
